...
return [
    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'paths'         => [
                base_path('src/App/Services/Authentication/Doctrine/Mapping'),
                base_path('src/Contexts/Account/Infrastructure/Doctrine/Mapping'),
                base_path('src/Contexts/OneTimePassword/Infrastructure/Doctrine/Mapping'),
            ],
    ...
    */
    'custom_types'               => [
        // Services
        'AuthAccountId' => \App\Services\Authentication\Doctrine\Types\DoctrineAuthAccountId::class,

        // Contexts
        'AccountId' => \Contexts\Account\Infrastructure\Doctrine\Types\DoctrineAccountId::class,
        'OneTimePasswordId' => \Contexts\OneTimePassword\Infrastructure\Doctrine\Types\DoctrineOneTimePasswordId::class,
    ],
    /*
    |--------------------------------------------------------------------------
